...
#let cover_page(
  ...
  pad(
    ...
    stack(
      ...
      v(5mm),
      line(start: (0pt, 0pt), length: 100pt, stroke: 1mm),
      v(12mm),
      // Faculty
      text(faculty, size: 12pt, weight: "bold"),
      v(5mm),
      // Department
      text(translations.department-of + " " + department, size: 15pt),
    ),
  )
  ...
  place(
    ...
    box(
      align(
        left,
        stack(
          line(start: (0pt, 0pt), length: 55pt, stroke: 0.9mm),
          v(3mm),
          text("Indian Institute of Science", size: 12pt, weight: "bold"),
          v(2mm),
          text("Education and Research, Kolkata", size: 12pt, weight: "bold"),
          v(2mm),
          text("Dept. of Physical Sciences", size: 12pt),
        ),
      ),
    ),
  )
